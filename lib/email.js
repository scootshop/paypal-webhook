...
function formatMoney(value, currency) {
  ...
  return new Intl.NumberFormat("es-ES", { style: "currency", currency: currency || "EUR" }).format(v);
}
...
function renderOrderEmailHTML({
  ...
  const LOGO_URL = "https://scootshop.co/Img/0-removebg-preview.png"; // tu logo
                  ...
                  <td style="padding:14px;">
                    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                      <tr>
                        ...
                        <td style="padding-left:12px;vertical-align:top;font-family: 'Courier New', Courier, monospace;">
                ...
                <tr>
                  <td align="left">
                    <a href="${primaryCtaUrl}" target="_blank" rel="noopener noreferrer"
                       style="display:inline-block;background:#111827;color:#FFFFFF;text-decoration:none;font-family: 'Courier New', Courier, monospace;font-size:14px;font-weight:800;padding:12px 16px;border-radius:12px;">
                      Ir a Scoot Shop
                    </a>
                    <a href="${WHATSAPP_URL}" target="_blank" rel="noopener noreferrer"
                       style="display:inline-block;margin-left:10px;background:#F3F4F6;color:#111827;text-decoration:none;font-family: 'Courier New', Courier, monospace;font-size:14px;font-weight:800;padding:12px 16px;border-radius:12px;border:1px solid #E5E7EB;">
                      WhatsApp soporte
                    </a>
                  </td>
                </tr>
