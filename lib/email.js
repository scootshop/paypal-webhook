    ...
    <tr>
      <td align="center" style="padding:0 12px;">
        <table role="presentation" width="640" cellspacing="0" cellpadding="0" border="0" style="max-width:640px;width:100%;">
          ...
          <!-- Top gradient bar -->
          <tr>
            <td style="background:linear-gradient(40deg,#dedede,#ffffff,#ffffff,#ffffff);border-radius:18px 18px 0 0;padding:18px 18px 12px 18px;">
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                <tr>
                  <td align="left" style="vertical-align:middle;">
                    <a href="${BRAND.URL}" target="_blank" rel="noopener noreferrer" style="text-decoration:none;">
                      <img src="${BRAND.LOGO_URL}" width="140" alt="${BRAND.NAME}" style="display:block;border:0;outline:none;height:auto;">
                    </a>
                  </td>
